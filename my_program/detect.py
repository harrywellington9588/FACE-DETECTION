...
class Detector():
    def __init__(self, p_params=r"D:\pycharm_project\yxy_mtcnn\parameters\o_params.pkl",
                 r_params=r"D:\pycharm_project\yxy_mtcnn\parameters\r_params.pkl",
                 o_params=r"D:\pycharm_project\yxy_mtcnn\parameters\o_params.pkl", isCuda=False):
        self.isCuda = isCuda
        self.pnet = net.pnet()
        self.rnet = net.rnet()
        self.onet = net.onet()
    ...
    def __pnet_detect(self, image):
        ...
        return tool.NMS(np.array(boxes), 0.8)
    ...
    def __rnet_detect(self, image, pnet_boxes):
        ...
        return tool.NMS(np.array(boxes), 0.9)
